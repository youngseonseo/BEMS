package energypa.bems.login.advice;

import energypa.bems.login.advice.error.DefaultAuthenticationException;
import energypa.bems.login.advice.error.DefaultException;
import energypa.bems.login.advice.error.DefaultNullPointerException;
import energypa.bems.login.advice.error.InvalidParameterException;
import energypa.bems.login.advice.payload.ErrorCode;
import energypa.bems.login.advice.payload.ErrorResponse;
